...
class _MyFruitState extends State<MyFruit> {
  ...
  final List<Map<String, String>> recipes = [
    {'image': 'fruit/fresh food salad.jpg', 'name': "Fresh Food Salad"},
    {'image': 'fruit/fruit filled french toast.png', 'name': "Fruit Filled \nFrench Toast"},
    {'image': 'fruit/gran granola parfaits.jpg', 'name': "Gran Granola \nParfaits"},
    {'image': 'fruit/honey lemon fruit.jpg', 'name': "Honey Lemon Fruit"},
    {'image': 'fruit/hot spice fruit.png', 'name': "Hot Spice Fruit"},
    {'image': 'fruit/powerhouse protein parfaits.jpg', 'name': "Powerhouse Protein \nParfaits"},
    {'image': 'fruit/strawberry banana crepes.jpg', 'name': "Strawberry Banana Crepes"},
    {'image': 'fruit/summer-fruit-breakfast-bak.jpg', 'name': "Summer Fruit \nBreakfast Bak"},
    {'image': 'fruit/winter-fruit-salad.jpg', 'name': "Winter Fruit Salad"},
    {'image': 'fruit/yogurt and honey fruit cups.png', 'name': "Yogurt and Honey \nFruit Cups"},
  ];
