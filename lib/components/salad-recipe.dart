...
class MySalad extends StatefulWidget {
  const MySalad({super.key});

  @override
  State<MySalad> createState() => _MySaladState();
}

class _MySaladState extends State<MySalad> {
  // List of recipes with image paths and names
  final List<Map<String, String>> recipes = [
    {'image': 'salad/perfect-spinach-salad.jpg', 'name': "Perfect Spinach Salad"},
    {'image': 'salad/rainbow nchopped salad with basil and mozzarella.jpg', 'name': "Rainbow Chopped \nSalad with Basil"},
    {'image': 'salad/roasted beet goat cheese salad.jpg', 'name': "Roasted Beef Goat \nCheese Salad"},
    {'image': 'salad/sauteed mediterranean lentil salad.jpg', 'name': "Sauteed Mediterranean \nLentil Salad"},
    {'image': 'salad/simple butter lettuce salad.jpg', 'name': "Simple Butter \nLettuce Salad"},
    {'image': 'salad/Simple-Italian-Salad.jpg', 'name': "Simple Italian Salad "},
    {'image': 'salad/Summer-Corn-Salad.jpg', 'name': "Summer Corn Salad"},
    {'image': 'salad/the-perfect-greek-salad.jpg', 'name': "The Perfect Greek Salad"},
    {'image': 'salad/tomato-cucumber-avocado-salad.jpg', 'name': "Tomato Cucumber \nAvocado Salad"},
    {'image': 'salad/Vegan-Roasted-Sweet-Potato-Salad.jpg', 'name': "Vegan Roasted \nSweet Potato Salad"},
  ];
