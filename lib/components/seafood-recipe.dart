...
class MySeafood extends StatefulWidget {
  const MySeafood({super.key});

  @override
  State<MySeafood> createState() => _MySeafoodState();
}

class _MySeafoodState extends State<MySeafood> {
  // List of recipes with image paths and names
  final List<Map<String, String>> recipes = [
    {'image': 'seafood/cajun_grilled_shrimp_boil.jpg', 'name': "Cajun Grilled \nShrimp Boil"},
    {'image': 'seafood/feta-shrimp-skillet.png', 'name': "Feta Shrimp Skillet"},
    {'image': 'seafood/greek-tilapia.png', 'name': "Greek Tilapia"},
    {'image': 'seafood/salmon-stir-fry.jpg', 'name': "Salmon Stir Fry"},
    {'image': 'seafood/seafood-boil.jpg', 'name': "Seafood Boil"},
    {'image': 'seafood/seafood-casserole.jpg', 'name': "Seafood Casserole"},
    {'image': 'seafood/seafood-lasagna.jpg', 'name': "Seafood Lasagna"},
    {'image': 'seafood/Shrimp-Tortellini-Pasta-Toss.jpg', 'name': "Shrimp Tortellini \nPasta Toss"},
    {'image': 'seafood/Thai-Scallop-Saute.jpg', 'name': "Thai Scallop Saute"},
    {'image': 'seafood/tilapia-with-corn-salsa.jpg', 'name': "Tilapia with \nCorn Salsa"},
  ];
