...
class MySoup extends StatefulWidget {
  const MySoup({super.key});

  @override
  State<MySoup> createState() => _MySoupState();
}

class _MySoupState extends State<MySoup> {
  // List of recipes with image paths and names
  final List<Map<String, String>> recipes = [
    {'image': 'soup/Broccoli-Cheese-Soup-10-1.jpg', 'name': "Broccoli Cheese Soup"},
    {'image': 'soup/chicken-sotanghon-soup.jpg', 'name': "Chicken Sotanghon Soup"},
    {'image': 'soup/fast-pho.jpg', 'name': "Fast Pho"},
    {'image': 'soup/ginas soicy corn chowder.jpg', 'name': "Ginas Soicy \nCorn Chowder"},
    {'image': 'soup/greek fisherman stew.jpg', 'name': "Greek Fisherman Stew"},
    {'image': 'soup/Han Bean Soup.png', 'name': "Han Bean Soup"},
    {'image': 'soup/Macaroni-Chicken-Sopas.jpg', 'name': "Macaroni Chicken Sopas"},
    {'image': 'soup/perfect-potato-soup.jpg', 'name': "Perfect Potato Soup"},
    {'image': 'soup/italian meatball soup.jpg', 'name': "Italian Meatball Soup"},
    {'image': 'soup/potato-leek-soup.jpg', 'name': "Potato Leek Soup"},
  ];
