...
class _MyKidsState extends State<MyKids> {
  ...
  final List<Map<String, String>> recipes = [
    {'image': 'kids/Bacon Cheese Burger.png', 'name': "Bacon Cheese Burger"},
    {'image': 'kids/baked chicken nuggets.jpg', 'name': "Baked Chicken Nuggets"},
    {'image': 'kids/Baked Ham and Mozarella Cheese.png', 'name': "Baked Ham and \nMozarella Cheese"},
    {'image': 'kids/bbq meat loaf mini.jpg', 'name': "BBQ Meat \nLoaf Mini"},
    {'image': 'kids/beef-enchiladas.jpg', 'name': "Beef Enchiladas"},
    {'image': 'kids/buttermilk-waffle bacon and egg sandwich.jpg', 'name': "Waffle Bacon and \nEgg Sandwich"},
    {'image': 'kids/cheese burger french friy casserole.jpg', 'name': "Cheese Burger French \nFry Casserole"},
    {'image': 'kids/classic grilled cheese sandwich.jpg', 'name': "Classic Grilled \nCheese Sandwich"},
    {'image': 'kids/cornflake chicken.jpg', 'name': "Cornflake Chicken"},
    {'image': 'kids/easy-Spaghetti.jpg', 'name': "Easy Spaghetti"},
  ];
