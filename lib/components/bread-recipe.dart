...
class MyBread extends StatefulWidget {
  const MyBread({super.key});

  @override
  State<MyBread> createState() => _MyBreadState();
}

class _MyBreadState extends State<MyBread> {
  // List of recipes with image paths and names
  final List<Map<String, String>> recipes = [
    {'image': 'bread/apple-bread.jpg', 'name': "Apple Bread"},
    {'image': 'bread/banana-bread.jpg', 'name': "Banana Bread. "},
    {'image': 'bread/Best-Zucchini-Bread.jpg', 'name': "Best Zucchini Bread"},
    {'image': 'bread/blueberry-cornbread.jpg', 'name': "Blueberry Cornbread"},
    {'image': 'bread/Caramel-Pecan-Rolls.jpg', 'name': "Caramel Pecan Rolls"},
    {'image': 'bread/chocolate chai mini loaves.png', 'name': "Chocolate Chai \nMini Loaves"},
    {'image': 'bread/chocolate chip loap.jpg', 'name': "Chocolate Chip Loap"},
    {'image': 'bread/classic challah.png', 'name': "Classic Challah"},
    {'image': 'bread/coco bread.jpg', 'name': "Coco Bread"},
    {'image': 'bread/texas roadhouse rolls.jpg', 'name': "Texas Roadhouse Rolls"},
  ];
