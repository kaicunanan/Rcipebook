...
class _MyChickenState extends State<MyChicken> {
  ...
  final List<Map<String, String>> recipes = [
    {'image': 'Chicken/Air-Fryer-Chicken.jpg', 'name': "Air Fryer \nChicken"},
    {'image': 'Chicken/chicken-and-rice-casserole.jpg', 'name': "Chicken and \nRice Casserole"},
    {'image': 'Chicken/chicken-cilantro-wontons.jpg', 'name': "Chicken Cilantro \nWontons"},
    {'image': 'Chicken/Chicken-Fajitas.jpg', 'name': "Chicken \nFajitas"},
    {'image': 'Chicken/chicken-marsala.jpg', 'name': "Chicken \nMarsala"},
    {'image': 'Chicken/chinese-bbq-chicken.jpg', 'name': "Chinese BBQ \nChicken"},
    {'image': 'Chicken/Curried Fried Rice.jpg', 'name': "Curried Fried \nRice"},
    {'image': 'Chicken/gameday-buffalo-wing.jpg', 'name': "Game Day \nBuffalo Wings"},
    {'image': 'Chicken/Honey-Garlic-Chicken-Wings.jpg', 'name': "Honey Garlic \nChicken Wings"},
    {'image': 'Chicken/sweet-chili-chicken-bites.jpg', 'name': "Sweet Chili \nChicken Bites"},
  ];
