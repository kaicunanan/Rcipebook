...
class MyEgg extends StatefulWidget {
  const MyEgg({super.key});

  @override
  State<MyEgg> createState() => _MyEggState();
}

class _MyEggState extends State<MyEgg> {
  // List of recipes with image paths and names
  final List<Map<String, String>> recipes = [
    {'image': 'eggs/BLT-Quinoa-Bowls.jpg', 'name': "BLT Quinoa Bowls"},
    {'image': 'eggs/Carbonara+Gnocchi+Bake.png', 'name': "Carbonara Gnocchi Bake"},
    {'image': 'eggs/Chakchouka.jpg', 'name': "Chakchouka"},
    {'image': 'eggs/cheesy_-egg-skillet.jpg', 'name': "Cheesy Egg Skillet"},
    {'image': 'eggs/Chef-Johns-Loco-Moco.jpg', 'name': "Chef Johns Loco Moco"},
    {'image': 'eggs/Chilaquilles.png', 'name': "Chilaquilles"},
    {'image': 'eggs/Chorizo-Breakfast-Hash.png', 'name': "Chorizo Breakfast Hash"},
    {'image': 'eggs/croque-madame.jpg', 'name': "Croque Madame"},
    {'image': 'eggs/huevos_rancheros.jpg', 'name': "Huevos Rancheros"},
    {'image': 'eggs/Moonstruck-Egg.png', 'name': "Moonstruck Egg"},
  ];
